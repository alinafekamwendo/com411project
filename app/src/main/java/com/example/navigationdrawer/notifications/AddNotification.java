...
public class AddNotification extends AppCompatActivity {
    public static final String TITLE= "com.example.navigationdrawer.notifications.TITLE";
    public static final String TIME= "com.example.navigationdrawer.notifications.TIME";
    public static final String MESSAGE= "com.example.navigationdrawer.notifications.MESSAGE";
